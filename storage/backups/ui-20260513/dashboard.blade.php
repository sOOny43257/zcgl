<x-app-layout>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        $cards = [
            ...
            ['label' => '在用', 'value' => $statusCounts['在用'], 'color' => 'emerald', 'icon' => 'M5 13l4 4L19 7', 'route' => route('assets.index', ['statuses[]' => '在用'])],
            ['label' => '借用中', 'value' => $statusCounts['借用'], 'color' => 'purple', 'icon' => 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4', 'route' => route('borrows.manage')],
            ['label' => '闲置', 'value' => $statusCounts['闲置'], 'color' => 'amber', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'route' => route('assets.index', ['statuses[]' => '闲置'])],
            ['label' => '维修/待报废', 'value' => $statusCounts['维修'] + $statusCounts['待报废'], 'color' => 'orange', 'icon' => 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z', 'route' => route('assets.index', ['statuses[]' => '维修', 'statuses[]' => '待报废'])],
        ];
        @endphp
