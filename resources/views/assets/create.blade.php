            ...
            <form method="POST" action="{{ route('assets.store') }}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="ip" value="{{ old('ip') }}" class="w-full border border-gray-300 rounded-lg py-2.5 px-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="mac" value="{{ old('mac') }}" placeholder="00:1A:2B:3C:4D:5E" class="w-full border border-gray-300 rounded-lg py-2.5 px-3 text-sm font-mono focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
