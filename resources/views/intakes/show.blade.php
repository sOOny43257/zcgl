    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="{{ route('print.universal', ['module' => 'intake', 'id' => $intake->id]) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 border border-gray-300 text-sm rounded-lg hover:bg-gray-50">
