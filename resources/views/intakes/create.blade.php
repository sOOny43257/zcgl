<x-app-layout>
                    ...
                    <tbody>
                        <template x-for="(item, index) in items" :key="index">
                            <tr class="border-t border-gray-100">
                                ...
                                <td class="px-2 py-2">
                                    <input type="text" :name="'items['+index+'][category]'" x-model="item.category" class="w-28 border border-gray-200 rounded py-1.5 px-2 text-sm" placeholder="类别">
                                </td>
                                <td class="px-2 py-2">
                                ...
                                <td class="px-2 py-2">
                                    <input type="text" :name="'items['+index+'][department]'" x-model="item.department" class="w-24 border border-gray-200 rounded py-1.5 px-2 text-sm">
                                </td>
                                <td class="px-2 py-2">
    ...
    function intakeItems() {
        return {
            items: [{ name: '', category: '', brand: '', model: '', sn: '', department: '', room: '', user: '', purchase_price: '', financial_code: '', remarks: '' }],
            addItem() {
